...
Jak je zřejmé s parametrů rozložení, poloha tohoto rozložení určena průměrem a šířka rozložení bude ovlivněna $\frac{\sigma_p}{\sqrt{n}}$, tedy mírou variability v datech a velikostí našeho výběru. Čím větší velikost výběru, tím menší je směrodatná odchylka rozložení parametru^[Tento vztah není lineární, tedy 2x větší výběr neznamená 2x menší směrodatnou odchylku rozložení parametru, směrodatná odchylka rozložení klesá $\frac{1}{\sqrt{n}}$]. Aby nedocházelo k záměně směrodatné odchylky rozložení parametru a směrodatné odchylky výběru, používá se pro směrodatnou odchylku rozložení parametru pojem **směrodatná chyba**. 
...
```{r clv-t, fig.cap='Porovnání vlivu velikosti výběru n na směrodatnou chybu odhadu', fig.width=10, fig.height=7}
...
```{r, fig.cap='Ukázka opakovaných výběrů z populace a '}
