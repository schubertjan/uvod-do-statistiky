...
pdf_vyber <- dt((x - bodovy_odhad) / smerodatna_chyba_odhadu, 
          df = df) * 1/smerodatna_chyba_odhadu
h0 <- 180
...
legend("topright",
       legend = c("Výběr. rozděl. průměru", "Výběr. rozděl. H0", "Bodový odhad"),
       col = c("#1f77b4", "grey", "black"),
       lwd = c(2, 2, 1),
       lty = c(1, 1, 2),
       cex = 0.7)
