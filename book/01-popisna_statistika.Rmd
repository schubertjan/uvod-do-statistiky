...
premier <- readLines("../dats/vlada.txt")
...
stopwords <- readLines("../dats/stopwords.txt", encoding = "UTF-8")
...
legend("topright", legend = c("Premiér", "Prezident"), col = c("#1f77b4", "black"), lwd = c(3,3), cex = 0.8)
```
...
## Cvičení 
Vytvořte funkci na výpočet percentilu.
