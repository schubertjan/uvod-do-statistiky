...
## Cvičení 
1. Vytvořte funkci na výpočet percentilu.
2. Načtěte projev předsedy Senátu [zde](https://raw.githubusercontent.com/schubertjan/uvod-do-statistiky/master/dats/senat.txt). Který projev je nejdelší? Který ústavní činitel má v průměru nejdelší věty? Jak se liší směrodatná odchylka počtu slov ve větě a co to znamená?
