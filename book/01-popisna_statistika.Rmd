...
V `R` můžeme kvantily vypočítat pomocí funkce `quantile`. V argumentu `prob` stanovíme jakou pravděpodobnost (percentil) chceme vypočítat. Například vypočítejme  kvartily počtu slov. Vidíme, že 25% vět má méně než 9 slov a že 25% vět má více než 23 slov (nebo že 75% vět má méně než 23 slov).
```{r}
quantile(pocet_slov, prob = c(0.25, 0.5, 0.75))
```

Percentil a mezikvantilove a rozpětí